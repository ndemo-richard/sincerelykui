...
export default function mentalHealth({ posts}) {
  ...
  return (
    ...
    <div className={styles.module_header}>
      ...
      <div className={styles.main}>
        <h1 className={styles.myblog_title}>MENTAL HEALTH</h1>

        <h3 className={styles.myblog_description}>Treat yourself</h3>
...
export const getServerSideProps = async pageContext => {
  const query = encodeURIComponent('*["mental_health" in categories[]->title][0...3]{_id,"slug": slug.current,title,body,mainImage,publishedAt,"authorImage":author->image,"authorName":author->name}',);
