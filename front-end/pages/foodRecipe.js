...
import styles from '../styles/FoodRecipe.module.scss'
...
export default function foodRecipe({ posts}) {
  ...
  return (
    ...
    <div className={styles.module_header}>
      ...
      <div className={styles.main}>
        <h1 className={styles.myblog_title}>FOOD RECIPE</h1>

        <h3 className={styles.myblog_description}>Eat Healthy and drink river water</h3>
...
export const getServerSideProps = async pageContext => {
  const query = encodeURIComponent('*["food_recipe" in categories[]->title][0...3]{_id,"slug": slug.current,title,body,mainImage,publishedAt,"authorImage":author->image,"authorName":author->name}',);
